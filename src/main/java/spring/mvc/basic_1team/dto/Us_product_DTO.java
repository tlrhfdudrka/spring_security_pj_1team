...
public class Us_product_DTO {
	...
	public Us_product_DTO() {}

	public Us_product_DTO(int pd_num, int category_num, String pd_name, int pd_price, int pd_stuck, String pd_content,
