...
<body>
			...
			<div id="join-form">
				<div id="contents">
				<div class="caption">
		  		<a href="login.do" class="create-account">SIGN IN</a>
		  		<a href="" class="create-account_2">CREATE ACCOUNT</a>
				</div>
               ...
               <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">  
		            ...
		            <div class="int-area">
		                ...
		                <label for="id"  class="right">(영문소문자/숫자,4~16자)</label>
		            </div>
		            ...
		            <div class="int-area">
		                ...
		                <label for="pw" class="right">(영문 대소문자/숫자/특수문자 중 2가지 이상 조합,10자~16자)</label>
		            </div>
		             
		           
		            <div class="int-area">
		                <input type="password" name="pw_check" id="pw_check" autocomplete="off" required>
		                <label for="pw_check">Password confirm</label>
		            </div>
		            ...
		            <div class="int-area">
		             ...
		             <div class="int-area">
		                <input type="text" name="user_address" id="address" autocomplete="off" required>
		                <label for="address">Address</label>
		            </div>
		            
		            <div class="int-area">
		                <input type="text" name="user_hp" id="mobile" autocomplete="off" required>
		         ...
		         <div class="accordion-section">
		 		  ...
		 		  <button class="accordion-button" onclick="toggleAccordion('section2')">
		   			>[필수] 이용약관 동의
		   		  </button>
		  		...
		  		<button class="accordion-button" onclick="toggleAccordion('section3')">
		    		>[필수] 개인정보 수집 및 이용 동의
		  		</button>
				...
				<button class="accordion-button" onclick="toggleAccordion('section4')">
		 		   >[선택]쇼핑정보 수신 동의<br>SMS 수신을 동의하십니까?<br>이메일 수신을 동의하십니까?
				</button>
